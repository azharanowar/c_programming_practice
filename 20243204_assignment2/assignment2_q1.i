...
int main()
{
    ...
    float num, userNumberOne, userNumberTwo;
    ...
    for (int i = 1; i <= num; i++) {
        ...
        printf("The min number between %f and %f is: \n", userNumberOne, userNumberTwo, ((userNumberOne) > (userNumberTwo) ? (userNumberTwo) : (userNumberOne)));
    }
